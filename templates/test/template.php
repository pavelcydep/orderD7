        ...
        <div class="sticky-top">
           <div class="cheque">
              <div class="cheque-item">
                 ...
                 Товара: <span class="cheque-price">
                 <?=
              ...
              <div class="cheque-item cheque-item-deliv">
	             ...
	             ?> <span class="cheque-price del4" style="display:none;"> <span class="delivery_price"></span> </span>
              </div>
              <div class="cheque-dash cheque-dash-deliv"></div>
              <div class="cheque-item">
                 Итого: <span class="cheque-price cheque-price_big"><?=$component->order->getPrice();?><span class="total-price"></span> </span>
              </div>
